...
(
	...
	cmake \
		...
		-DOGR_DRIVER_HANA_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-hana package." \
		-D          OGR_ENABLE_DRIVER_OCI_PLUGIN=ON \
		-DOGR_DRIVER_OCI_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-oracle package." \
		-D        GDAL_ENABLE_DRIVER_GEOR_PLUGIN=ON \
		-DGDAL_DRIVER_GEOR_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-oracle package." \
		-D         GDAL_ENABLE_DRIVER_ECW_PLUGIN=ON \
		-DGDAL_DRIVER_ECW_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-ecw package." \
		-D       GDAL_ENABLE_DRIVER_MRSID_PLUGIN=ON \
		-DGDAL_DRIVER_MRSID_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-mrsid package." \
		-D        GDAL_ENABLE_DRIVER_HDF5_PLUGIN=ON \
		-DGDAL_DRIVER_HDF5_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-hdf5 package." \
		-D         GDAL_ENABLE_DRIVER_KEA_PLUGIN=ON \
		-DGDAL_DRIVER_KEA_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-kea package." \
		-D      GDAL_ENABLE_DRIVER_TILEDB_PLUGIN=ON \
		-DGDAL_DRIVER_TILEDB_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-tiledb package." \
		-D      OGR_ENABLE_DRIVER_FILEGDB_PLUGIN=ON \
		-DOGR_DRIVER_FILEGDB_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-filegdb package." \
		-D         OGR_ENABLE_DRIVER_SOSI_PLUGIN=ON \
		-DOGR_DRIVER_SOSI_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-sosi package." \
		-D OGR_ENABLE_DRIVER_MSSQLSPATIAL_PLUGIN=ON \
		-DOGR_DRIVER_MSSQLSPATIAL_PLUGIN_INSTALLATION_MESSAGE="You may enable it by installing the gdal-dev-mss package." \
