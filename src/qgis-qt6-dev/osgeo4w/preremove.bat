del "%OSGEO4W_STARTMENU%\QGIS Desktop @version@ (Nightly; Qt6).lnk"
del "%OSGEO4W_STARTMENU%\Qt Designer with QGIS @version@ custom widgets (Nightly; Qt6).lnk"
rmdir "%OSGEO4W_STARTMENU%"
del "%OSGEO4W_DESKTOP%\QGIS Desktop @version@ (Nightly; Qt6).lnk"
del "%OSGEO4W_DESKTOP%\Qt Designer with QGIS @version@ custom widgets (Nightly; Qt6).lnk"
