...
rmdir /s /q "%OSGEO4W_ROOT%\apps\@package@\python\plugins\sagaprovider\saga\description"
rmdir /s /q "%OSGEO4W_ROOT%\apps\@package@\python\plugins\sagaprovider\saga\description.dist"
del "%OSGEO4W_ROOT%\apps\@package@\python\plugins\sagaprovider\SagaNameDecorator.py"
del "%OSGEO4W_ROOT%\apps\@package@\python\plugins\sagaprovider\SagaNameDecorator.py.dist"
