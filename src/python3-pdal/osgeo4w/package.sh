...
export BUILDDEPENDS="base python3-pip python3-wheel python3-setuptools python3-devel python3-numpy python3-pybind11 python3-packaging python3-pyparsing pdal-devel"
